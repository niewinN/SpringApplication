...
//                .antMatchers("/edit_address/70}").permitAll()
...
//                .antMatchers("/edit_sauna").access("hasRole('ADMIN')")
                ...
                .antMatchers("/new_customer").access("hasRole('ADMIN')")
                .antMatchers("/new_empl").access("hasRole('ADMIN')")
                .antMatchers("/new_sauna").access("hasRole('ADMIN')")
                .antMatchers("/new_service").access("hasRole('ADMIN')")
